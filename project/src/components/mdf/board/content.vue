<template>
	<section class="flex justify-between gap-6 w-full">
		<div class="flex flex-col gap-6 flex-[7] sticky-container">
			<div class="mb-2 p-4 border rounded-lg bg-white">
				<div class="flex justify-between items-center">
					<strong class="text-cyan-500 font-bold">예측 결과 요약</strong>
					<span class="text-sm text-gray-800">더보기</span>
				</div>
				<p class="max-w-full mt-1 text-sm overflow-hidden text-ellipsis line-clamp-1 text-left">
